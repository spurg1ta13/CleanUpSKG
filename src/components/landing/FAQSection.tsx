...
const faqData = [
  ...
  },
  {
    ...
    a: {
      el: "Όχι απαραίτητα. Πολλοί πελάτες μας αφήνουν κλειδί ή δίνουν πρόσβαση. Οι ομάδες μας αποτελούνται από αξιόπιστο προσωπικό με εγγυημένο επαγγελματισμό και συνέπεια.",
      en: "Not necessarily. Many of our clients leave a key or provide access. Our teams consist of reliable staff with guaranteed professionalism and consistency.",
      ru: "Не обязательно. Многие клиенты оставляют ключ или предоставляют доступ. Наши команды состоят из надёжного персонала с гарантированным профессионализмом и ответственностью.",
    },
  },
];
