...
const faqData = [
  ...
  },
  {
    ...
    a: {
      el: "Η τιμή εξαρτάται από το μέγεθος του χώρου και τον βαθμό μόλυνσης. Επικοινωνήστε μαζί μας για δωρεάν εκτίμηση — οι τιμές μας ξεκινούν από €5/τ.μ.",
      en: "The cost depends on the space size and contamination level. Contact us for a free estimate — our prices start from €5 per square meter.",
      ru: "Стоимость зависит от площади и степени загрязнения. Свяжитесь с нами для бесплатной оценки — наши цены начинаются от €5 за кв. м.",
    },
  },
  {
    q: {
