        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
          <div>
            <div className="rounded-2xl h-[300px] overflow-hidden">
              <img src={commercialImg} alt="Professional commercial cleaning service for offices, restaurants and kitchens in Thessaloniki" className="w-full h-full object-cover" loading="lazy" decoding="async" width={600} height={300} />
            </div>
          </div>
          <div>
