...
export const translations = {
  ...
  hero: {
    ...
    subtitle: {
      el: "Ολοκληρωμένες λύσεις καθαρισμού για οικίες, επιχειρήσεις και εργοτάξια στον νόμο Θεσσαλονίκης.",
  ...
  about: {
    ...
    description: {
      el: "Η CleanUp SKG αποτελεί μια σύγχρονη και αξιόπιστη ομάδα καθαρισμού με έδρα την Καλαμαριά. Επιδίωξή μας είναι η διατήρηση υψηλών προδιαγραφών καθαριότητας σε κάθε χώρο που αναλαμβάνουμε.\n\nΠαρέχουμε εξειδικευμένες λύσεις καθαρισμού σε γραφεία, επαγγελματικούς χώρους, εργοτάξια και οικίες στην ευρύτερη περιοχή της Θεσσαλονίκης.",
  ...
  services: {
    ...
    postConstructionDesc: { el: "Πλήρης απομάκρυνση μπαζών, υπολειμμάτων κατασκευής και γυάλισμα μετά από ανακαινίσεις ή νέες οικοδομές.", en: "Thorough debris removal, construction residue cleanup, and polishing after renovations or new builds.", ru: "Полное удаление мусора, строительных остатков и полировка после ремонта или нового строительства." },
    commercial: { el: "Επαγγελματικός Καθαρισμός", en: "Professional Cleaning", ru: "Профессиональная Уборка" },
    commercialDesc: { el: "Καθαρισμός γραφείων, καταστημάτων, εστιατορίων και εταιρικών χώρων στη Θεσσαλονίκη — εγγυημένο άριστο αποτέλεσμα.", en: "Cleaning for offices, shops, restaurants, and corporate spaces in Thessaloniki — guaranteed excellent results.", ru: "Уборка офисов, магазинов, ресторанов и корпоративных помещений в Салониках — гарантированный отличный результат." },
