...
const texts = {
  el: {
    ...
    description: "Φρεσκάρετε καναπέδες, στρώματα & χαλιά με επαγγελματικό βιο-καθαρισμό. Προσφορά περιορισμένου χρόνου!",
    cta: "Κλείστε Τώρα",
    call: "Καλέστε μας",
  },
  en: {
      ...
      <div className="relative w-full max-w-2xl bg-background rounded-3xl shadow-2xl overflow-hidden animate-in zoom-in-95 duration-500">
        ...
        <div className="px-5 md:px-8 py-5 md:py-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <Button
              size="lg"
              className="w-full sm:flex-1 rounded-full font-bold text-base shadow-lg hover:shadow-xl transition-shadow"
              onClick={handleBook}
            >
              {t.cta}
            </Button>
