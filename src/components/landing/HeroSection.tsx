    ...
    <>
      <section id="home" className="relative overflow-hidden min-h-[70vh] flex items-center">
        <div className="absolute inset-0">
          <img src={heroImg} alt="Professional cleaning team providing residential and commercial cleaning services in Thessaloniki" className="w-full h-full object-cover" width={1200} height={800} fetchPriority="high" decoding="async" />
